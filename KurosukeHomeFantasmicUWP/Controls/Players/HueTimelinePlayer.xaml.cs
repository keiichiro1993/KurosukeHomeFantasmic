...
{
    public sealed partial class HueTimelinePlayer : UserControl
    {
        HueTimelinePlayerControlViewModel ViewModel { get; set; } = new HueTimelinePlayerControlViewModel();
        public HueTimelinePlayer()
        {
        ...
        {
            var playerControl = (HueTimelinePlayer)d;
            playerControl.ViewModel.Timeline = (Models.Timeline.Timeline)e.NewValue;
        }
    }

    public class HueTimelinePlayerControlViewModel : ViewModels.ViewModelBase
    {
