...
namespace KurosukeHomeFantasmicUWP.Views.Auth
{
    ...
    /// </summary>
    public sealed partial class AuthDialogHuePage : Page
    {
        public AuthDialogHuePageViewModel ViewModel { get; set; } = new AuthDialogHuePageViewModel();

        public AuthDialogHuePage()
        {
